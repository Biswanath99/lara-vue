...
CREATE TABLE `trn_voucher_2` (
  ...
  `date` date NOT NULL,
  `voucher_type` varchar(1024) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL,
  `voucher_number` varchar(64) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `reference_number` varchar(64) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `narration` varchar(4000) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `party_name` varchar(256) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL,
  `place_of_supply` varchar(256) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `trn_cost_centre_2` (
  `guid` varchar(64) NOT NULL,
  `ledger` varchar(1024) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `name` varchar(1024) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `trn_accounting_2` (
  ...
  `currency` varchar(16) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
