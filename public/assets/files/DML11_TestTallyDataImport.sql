...
CREATE TABLE `trn_cost_centre_2` (
  `guid` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ledger` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `trn_accounting_2` (
  ...
  `currency` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-01-07  8:10:45
