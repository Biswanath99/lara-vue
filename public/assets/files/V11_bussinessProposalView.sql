...
plvhprp.id parlvhProposalsPrimaryId,
plvhprp.proposalId parlvhProposalGenId,
...
AND   lvhprp.parentPropId = plvhprp.id
...
null parlvhProposalsPrimaryId,
null parlvhProposalGenId,
...
AND   lvhprp.pscmNo      = pscm.id
AND   cl.colonyAddressId = ad.id
AND   lvhprp.parentPropId IS null;