...
class OfflineApplicationDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offlineApplicationDetails', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('sessionId')->nullable();// FK applicationSession
            ...
            $table->integer('appStatusSeqNo')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('offlineApplicationDetails');
    }
}
